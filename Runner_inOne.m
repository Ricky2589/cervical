...
%=================================
if strcmp(dataset_name, 'TrainingSyntheticImages')
		imSize = 512;
		imNum = 3;
		imFilePath = '/home/mayank/Downloads/maynkcode/ims/TrainingSyntheticImages';
...
%=================================
if strcmp(dataset_name, 'TestSyntheticImages')
		imSize = 512;
		imNum = 15;
		imFilePath = '/home/mayank/Downloads/mayankcode/ims/TestSyntheticImages';
...
if strcmp(dataset_name, 'EDF')
		imSize = 1024;
		imNum = 4;
		imFilePath = '/home/mayank/Downloads/mayankcode/ims/EDF/';
...
%================================= 
if strcmp(dataset_name, 'TrainingSyntheticImages') || strcmp(dataset_name, 'TestSyntheticImages')
	 for i = 1:imNum
...
%=============================================================
try
    load(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'RawClump.mat'), 'RawClumpMaskSet');
    ...
    %       SAVE MAT FILE
    %===========================
    save(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'RawClump.mat'), ...
...
%=================================================================
try
    load(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'AccurateClumpLevelSet.mat'),  'imCBMaskSet', 'imCBMaskSetRefined', 'index_im2train', 'index_im2test', 'gmm_model_clump', 'gmm_model_background', 'gmm_post_training');
    ...
    %       SAVE MAT FILE
    %===========================
    save(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'AccurateClumpLevelSet.mat'), ...
...
%================================= 
try
    load(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'RawNucleiMask.mat'), 'imMaskSet4RawNucleiCandidatesAfterLevelSet');
    ...
    %       SAVE MAT FILE
    %===========================
    save(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'RawNucleiMask.mat'), ... 
...
%============================= 
try
    load(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'NucleiMask.mat'), 'nucleiMaskSet');
    ...
    %       SAVE MAT FILE
    %===========================
    save(strcat('/home/mayank/Downloads/mayankcode/ims/', storageCommonPath, 'NucleiMask.mat'), ... 
    ...
    for alphaID = 1:length(alfa_ellipseSet)				
        for lambdaID = 1:length(lambda_ellipseSet)						
            for gammaID = 1:length(gamma_ellipseSet)
                ...
                %       SAVE MAT FILE
                %===========================       
                save(strcat('/home/mayank/Downloads/mayankcode/ims/',storageInitial, '/Initial_LSF_alfa', num2str(alfa_ellipse),'_lambda', num2str(lambda_ellipse),...
            ...
            for gamma_extentID = 1:length(gamma_extentSet)                  
                for zita_extentID = 1:length(zita_extentSet)                
                    for omega_extentID = 1:length(omega_extentSet)
                        ...
                        %       SAVE MAT FILE
                        %===========================
                        save(strcat('/home/mayank/Downloads/mayankcode/ims/',storageExtent,'/Final_LSF_alfa', num2str(alfa_extent),'_lambda', num2str(lambda_extent),...
